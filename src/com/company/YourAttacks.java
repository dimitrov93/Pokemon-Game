...
public class YourAttacks extends Pokemon implements YourAbility {
    ...
    public void AbilityChoice(Pokemon yourPokemon, Pokemon enemyPokemon) {
        attacksMenuOptions();
         loop: while (true) {
             byte attackAbility = abilityChoiceMenu();
             switch (attackAbility) {
                 ...
                 default -> System.out.println("Incorrect input! Please select proper option: ");
             }
         }
    }


    private byte abilityChoiceMenu() {

        byte attackAbility = scanner.nextByte();
        return attackAbility;
    }

    private void attacksMenuOptions() {
